      ...
      <div className="min-h-screen bg-gray-50 p-6 flex items-center justify-center">
        <div className="min-w-lg">
          ...
          <footer className="mt-6 text-center">
              <a href="https://wa.me/5551991306543" target="_blank" rel="noopener noreferrer">
            ...
            <div className="mt-6 p-4 bg-gray-100 rounded-md">
                        <h2 className="text-lg font-semibold text-gray-800">Contribua com a Obra de Deus</h2>
                        <p className="text-gray-600 mt-2">Se sentir no coração, você pode contribuir via Pix:</p>
                        <p className="text-gray-900 font-semibold mt-1">mocidadeibbf@gmail.com</p>
